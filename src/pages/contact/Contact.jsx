...
function Contact() {
  return (
    <React.Fragment>
        <div>
          <p className='py-5 text-center font-bold '>We are here to assist you with your needs. <br /> We are a text or a call away from to give a solution to your problems.</p>
          <form action="" className=' rounded-md bg-black text-white mx-5 py-5 px-5 flex flex-col gap-5'>
            <p className=' text-center text-2xl font-semibold'>Send us a direct mail</p>
          ...
          <div className=' flex gap-4 items-center'>
            <p><a href="tel:+2349163106779"><RiPhoneFill/></a></p>
            <p><a href="mailto:evanderomijeh4@gmail.com"><MdEmail/></a></p>
          </div>
          </form>
          <br /><br />
        </div>
